// 6. Por fim, o robô Curiosity tem uma taxa de sucesso de envio de mensagem de 60% devido ao fato de o robô já
...
const sendMarsTemperature = (onSuccess, onError) => {
  ...
  setTimeout(() => {
    if (MessageSentSuccessfully) onSuccess(marsTemperature);
